...
#ifndef PMODSF3_FREERTOS_H_
#define PMODSF3_FREERTOS_H_
...
#define SF3_COMMAND_SUBSECTOR_ERASE 0x20; // 3-byte address Subsector Erase command
...
#define SF3_SUBSECTOR_ERASE_BYTES 4
...
void SF3_freertos_SpiHandler(void *CallBackRef, u32 StatusEvent, unsigned int ByteCount);

#ifdef __cplusplus
}
#endif
#endif /* PMODSF3_FREERTOS_H_ */
